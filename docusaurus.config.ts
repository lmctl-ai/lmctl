...
const config: Config = {
  ...
  themeConfig: {
    ...
    announcementBar: {
      id: 'docs-target-lmctl-0-1-248',
      content:
        'These docs describe @lmctl-ai/lmctl 0.1.248. Run npm install -g @lmctl-ai/lmctl@latest --prefer-online and lmctl --version before following command examples.',
